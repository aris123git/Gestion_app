...
class StatCard(QFrame):
    ...
    def __init__(self, title: str, value: str='0', color: str='#2563eb', icon: str='', *, hint: str='', on_click: Optional[Callable[[], None]]=None):
        super().__init__()
        self.setObjectName('StatCard')
        self.setMinimumHeight(120)
        self._on_click = on_click
        self.setStyleSheet(f'#StatCard {{ background-color: {color}; border-radius: 14px; }}#StatCard QLabel {{ color: #ffffff; background: transparent; }}')
