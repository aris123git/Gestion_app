...
from PySide6.QtWidgets import QDialog, QFrame, QHBoxLayout, QLabel, QLineEdit, QMessageBox, QPushButton, QVBoxLayout
...
class ActivationDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle(t('Activation requise'))
        self.setModal(True)
        ...
        layout.addSpacing(6)
        layout.addWidget(QLabel(t("Entrez le code d'activation :")))
    ...
    def _activate(self) -> None:
        ...
        if activation_service.activate(code):
            self.activated = True
            QMessageBox.information(self, 'Activation', 'Logiciel activé avec succès. Merci !')
            self.accept()
        else:
            QMessageBox.critical(self, 'Activation', "Code d'activation invalide. Veuillez réessayer.")
