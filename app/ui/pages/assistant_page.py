...
from PySide6.QtWidgets import QAbstractItemView, QHBoxLayout, QHeaderView, QPushButton, QTableWidget, QTableWidgetItem, QVBoxLayout, QWidget
...
class AssistantPage(QWidget):
    ...
    def __init__(self, state: AppState):
        ...
        header = QHBoxLayout()
        header.addWidget(page_title(t('Assistant de gestion')))
        header.addStretch()
        ...
        self.table.setHorizontalHeaderLabels([t('Niveau'), t('Recommandation'), t('Détail')])
    ...
    def refresh(self) -> None:
        ...
        colors = {'danger': QColor('#fecaca'), 'warning': QColor('#fde68a'), 'info': QColor('#bfdbfe')}
